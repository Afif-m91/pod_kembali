...
$sql.=" FROM stt";
$query=mysqli_query($conn, $sql) or die("ajax-data.php: get reportpod");
...
if( !empty($requestData['search']['value']) ) {
	...
	$sql = "SELECT no_awb, no_do, cart_id, id_pengirim, penerima, alamat_penerima, kota, kilo, koli, tgl_kirim, tgl_terima, nama_penerima, jenis_barang, remarks, keterangan";
	$sql.=" FROM stt";
	...
	$query=mysqli_query($conn, $sql) or die("ajax-data.php: get reportpod"); // again run query with limit
